...
那是外祖父的遗物，从你记事起就挂在颈间，没摘下来过一天。""",
    ...
    "n00014": {
        ...
        "background_image": "assets/M1/01环境地图/白沙宋墓地形图.png",
        "choices": [
            {"text": "五点半有什么问题吗？", "next": "n00015"},
            {"text": "点点头，不说话", "next": "n00016"},
        ],
        "next": None
    },
...
你们靠近的时候，那人始终没有回头，手电光在地面缓慢移动，像是在寻找什么。""",
    ...
    "n00017": {
        ...
        "background_image": "assets/M1/01环境地图/白沙宋墓地形图.png",
        "choices": [
            {"text": "他在看土层", "next": "n00018"},
            {"text": "他在看植物", "next": "n00019"},
            {"text": "他在找东西", "next": "n00020"},
        ],
        "next": None
    },
    ...
    "n00023": {
        ...
        "background_image": "assets/M1/01环境地图/白沙宋墓地形图.png",
        "choices": [
            {"text": "东北—西南", "next": "n00024"},
            {"text": "西北—东南", "next": "n00025"},
            {"text": "东南—西北", "next": "n00024"},
        ],
        "next": None
    },
...
又是个读书的。""",
    ...
    "n00026": {
        ...
        "background_image": "assets/M1/01环境地图/白沙宋墓地形图.png",
        "choices": [
            {"text": "“读书不好吗？”", "next": "n00027"},
            {"text": "“赵师傅以前见过很多学生？”", "next": "n00028"},
            {"text": "不接话", "next": "n00029"},
        ],
        "next": None
    },
...
他蹲下去，抓起一把土在掌心搓了搓。""",
    ...
    "n00047": {
        ...
        "background_image": "assets/M1/01环境地图/白沙宋墓地形图.png",
        "choices": [
            {"text": "”只靠踩就能知道？“", "next": "n00048"},
            {"text": "”为什么不是自然土？“", "next": "n00049"},
            {"text": "蹲下来观察土色", "next": "n00050"},
        ],
        "next": None
    },
...
你先看。""",
    ...
    "n00051": {
        ...
        "choices": [
            {"text": "看夯层厚度", "next": "n00052"},
            {"text": "看夯窝", "next": "n00053"},
            {"text": "看土色", "next": "n00054"},
        ],
        "next": None
    },
...
外层横砖加菱角牙子混砌，中层全部横砖，内层全部卧丁砖。你看这三层，拆的顺序应该是什么？""",
    ...
    "n00055": {
        ...
        "background_image": "assets/M1/02墓道与墓门/插图三 第一号墓墓门外层封门砖的组织.png",
        "choices": [
            {"text": "从外层开始拆", "next": "n00056"},
            {"text": "从中层开始拆", "next": "n00057"},
            {"text": "从内层开始拆", "next": "n00058"},
        ],
        "next": None
    },
...
永安。你觉得是什么？""",
    ...
    "n00059": {
        ...
        "background_image": "assets/M1/02墓道与墓门/插图三 第一号墓墓门外层封门砖的组织.png",
        "choices": [
            {"text": "墓主人名字", "next": "n00060"},
            {"text": "年号", "next": "n00061"},
            {"text": "吉祥语", "next": "n00062"},
            {"text": "暂时无法判断", "next": "n00063"},
        ],
        "next": None
    },
...
这砖烧得透，火候足。烧一窑这样的砖，得废多少柴火。你说这人啊，活着的时候住砖房，死了还要住砖房，图啥呢？""",
    ...
    "n00064": {
        ...
        "background_image": "assets/M1/02墓道与墓门/插图三 第一号墓墓门外层封门砖的组织.png",
        "choices": [
            {"text": "“赵师傅，你家用的什么砖？”", "next": "n00065"},
            {"text": "笑笑不说话，继续低头编号。", "next": "n00066"},
            {"text": "“九百年了，烧它的人早没了，它还在。”", "next": "n00067"},
        ],
        "next": None
    },
...
你觉得接下来怎么做？""",
    ...
    "n00068": {
        ...
        "background_image": "assets/M1/02墓道与墓门/插图三 第一号墓墓门外层封门砖的组织.png",
        "choices": [
            {"text": "“继续拆吧。裂缝不大，应该不会有大问题。”", "next": "n00069"},
            {"text": "“停。先架支撑。”", "next": "n00070"},
            {"text": "“我去叫陈工来看看，他经验丰富。”", "next": "n00071"},
        ],
        "next": None
    },
...
刚进入甬道的时候，你的目光最先被什么吸引？""",
    ...
    "n00072": {
        ...
        "choices": [
            {"text": "顶部叠胜", "next": "n00073"},
            {"text": "东壁人物", "next": "n00074"},
            {"text": "西壁马匹", "next": "n00075"},
        ],
        "next": None
    },
...
如果让你画这条甬道，你会先画哪里？""",
    ...
    "n00080": {
        ...
        "background_image": "assets/M1/03甬道/第一号墓甬道顶叠胜彩画.png",
        "choices": [
            {"text": "墓主人夫妇是整面壁画的中心，用浮雕凸显其核心地位。", "next": "n00081"},
            {"text": "可能是两个不同的工匠团队分别完成的。", "next": "n00082"},
            {"text": "砖浮雕更省钱，所以只做了墓主人夫妇。", "next": "n00083"},
        ],
        "next": None
    },
...
她举起手电，从侧面照过去，这里不太对。""",
    ...
    "n00083": {
        "speaker": "系统",
        "text": """粟柏年摇了摇头。桌椅的浮雕和侍者的壁画在风格上是统一的，同一个人设计的。至于省钱，砖浮雕的工费不比画工低。
你走到北壁前，侧光下，屏风山水画颜料龟裂的地方，隐约浮出几道极细的墨线。你下意识凑近。
【周淼】
等等。
她举起手电，从侧面照过去，这里不太对。""",
...
你觉得这两具的性别是？""",
    ...
    "n00108": {
        ...
        "background_image": "assets/M1/00_墓葬全景与结构图/第一号墓后室平、剖面.png",
        "choices": [
            {"text": "两具都是男性", "next": "n00109"},
            {"text": "一男一女", "next": "n00110"},
            {"text": "看不出来", "next": "n00111"},
        ],
        "next": None
    },
