      ...
      rear_land_deed_closeup: {
        ...
        hotspots: [
          ...
          },
          {
            ...
            title: "行列与字数",
            body: "地券为砖质朱书，券文共十六行，文字倒写。\n券盖无字，并有“合同”背书。\n它是后室文书证据，需要与题记、人骨和砖床位置共同复查。",
            record: "地券为砖质朱书，券文十六行、倒写；券盖无字，并有“合同”背书。",
            sourceFile: "M1/16_出土器物与人骨/16_出土器物与人骨-增强线索表-v1.1.md",
            sourceClueId: "L03"
          },
          {
        ...
        hotspots: [
          {
            ...
            title: "人骨方向",
            body: "后室第二层砖床正中偏北发现二具人骨。\n人骨位置需要与砖床范围、铁钉和地券出土位置共同复查。\n不能仅凭人骨位置判断死因或具体身份。",
            record: "后室第二层砖床正中偏北发现二具人骨，需与砖床、铁钉和地券共同复查。",
            sourceFile: "M1/16_出土器物与人骨/16_出土器物与人骨-增强线索表-v1.1.md",
            sourceClueId: "L04"
          },
          {
            ...
            title: "铁钉数量",
            body: "后室记录中十九枚铁钉围成长约 98 厘米、宽约 88 厘米的范围。\n铁钉可辅助复原葬具范围。\n它不能单独推出盗扰、二次开棺或人为破坏。",
            record: "后室十九枚铁钉围出葬具范围，可与人骨和砖床位置叠合复查。",
            sourceFile: "M1/16_出土器物与人骨/16_出土器物与人骨-增强线索表-v1.1.md",
            sourceClueId: "L04"
          },
          {
