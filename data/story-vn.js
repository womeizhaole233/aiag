(() => {
  ...
  "version": "story-vn-text-new-20260621",
  ...
  "nodes": {
    ...
    "env_entry_001": {
      ...
      "kicker": "第一章  墓外",
      "speaker": "系统",
      "body": "粟柏年停在高地边缘，从口袋里掏出一张折叠整齐的坐标纸，在晨雾里抖开。\n\n纸上是白沙宋墓群的平面草图，M1在最南端，靠近水库取土区的边缘。",
      "backgroundImage": "assets/M1/01环境地图/白沙宋墓地形图.png",
      "portrait": null,
      "choices": [],
      "next": "env_entry_002",
    ...
    "env_entry_004": {
      ...
      "kicker": "第一章  墓外",
      "speaker": "粟柏年",
      "body": "白沙镇在这个位置。墓群坐落在这道南北向土岗的东坡，海拔比周围农田高出约十五米。\n\n东南高，西北低。土岗北侧那条干涸的河道——西北到东南走向。",
      "backgroundImage": "assets/M1/01环境地图/白沙宋墓地形图.png",
      "portrait": "assets/story/portraits/粟柏年.png",
      "choices": [],
      "next": "env_entry_005",
    ...
    "env_entry_009": {
      ...
      "kicker": "第一章  墓外",
      "speaker": "粟柏年",
      "body": "待会儿你要进的是一座完整的墓，是一个从外到内的空间系统。\n\n每走一步，前面的发现都会重新被后面的证据检验。",
      "backgroundImage": "assets/M1/01环境地图/白沙宋墓地形图.png",
      "portrait": "assets/story/portraits/粟柏年.png",
      "choices": [],
      "next": "env_entry_010",
    ...
    "env_close_002": {
      ...
      "kicker": "第一章  墓外",
      "speaker": "赵老倔",
      "body": "这一片夯过。土色发黏，有石灰。下面三尺，应该是墓道的填土。",
      "backgroundImage": "assets/M1/01环境地图/白沙宋墓地形图.png",
      "portrait": "assets/story/portraits/赵老倔.png",
      "choices": [],
      "next": "env_close_003",
